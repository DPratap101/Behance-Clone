        ...
        <div className="jp-modal_content">
          <div className="jp-modal_card">
            ...
            <ul className='jp-points'>
              <li><i class="fa-solid fa-id-card-clip"></i> Get proposals from creators matching your needs</li>
          ...
          <div className="jp-modal_card">
            ...
            <ul className='jp-points'>
              ...
              <li><i class="fa-solid fa-file-arrow-up"></i> Redirect applications to your favorite external tool</li>
              <li><i className="fa-solid fa-wand-magic-sparkles"></i> Job posts are free and expire after 30 days</li>
            </ul>
            <button onClick={() => alert('Posting a full-time job...')}>Post a Full-Time Job</button>
          </div>
        </div>
      </div>
    </div>
